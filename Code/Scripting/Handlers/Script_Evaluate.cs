                ...
                default:
                    ...
                    switch (op)
                    {
                        ...
                        case "IS_READY":
                            ...
                            {
                                case Var_Types.INT:
                                    id = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                                    break;
                                case Var_Types.STRING:
                                    id = Util.GetSkillID(System.Convert.ToString(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture));
                                    break;
                            }
                        ...
                        case "IS_ITEM_EQUIPPED":
                            ...
                            {
                                uint test_id = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        ...
                        case "IN_POLY":
                            if (source1_ob.Type == Var_Types.INT)
                            {
                                uint tmp_id = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
        ...
        private void EvaluateBinary(ScriptVariable dest_ob, string op, string var1, string var2)
        {
            ...
            switch (op)
            {
                case "IS_RESISTED":
                    ...
                    {
                        uint test_id = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        string command = System.Convert.ToString(source2_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                ...
                case "GROUP_HP":
                    ...
                    {
                        uint party_num = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        uint hp_thresh = System.Convert.ToUInt32(source2_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        uint needshp = 0;
                        uint hpp = 0;
                ...
                case "GROUP_MP":
                    ...
                    {
                        uint party_num = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        uint mp_thresh = System.Convert.ToUInt32(source2_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        uint needsmp = 0;
                        uint mpp = 0;
                ...
                case "GROUP_CP":
                    ...
                    {
                        uint party_num = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        uint cp_thresh = System.Convert.ToUInt32(source2_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        uint needscp = 0;
                        uint cpp = 0;
                        // Self
                ...
                case "IS_CLAN":
                    ...
                    {
                        uint test_id = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        string test_clan = System.Convert.ToString(source2_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        Clan_Info ci = null;
                        TargetType idType = Util.GetType(test_id);
                        switch (idType)
                        {
                ...
                case "IS_ALLY":
                    ...
                    {
                        uint test_id = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        string test_ally = System.Convert.ToString(source2_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        Clan_Info ci = null;
                        TargetType idType = Util.GetType(test_id);
                        switch (idType)
                        {
                ...
                case "IS_CLASS":
                    ...
                    {
                        uint test_id = System.Convert.ToUInt32(source1_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        string test_class = System.Convert.ToString(source2_ob.Value, System.Globalization.CultureInfo.InvariantCulture);
                        string class_name;
                        ...
                        switch (idType)
                        {
                            ...
                            case TargetType.NPC:
                                ...
                                break;
                            case TargetType.SELF:
                                class_name = System.Convert.ToString(Util.GetClass(Globals.gamedata.my_char.ActiveClass), System.Globalization.CultureInfo.InvariantCulture);
                            ...
                            case TargetType.PLAYER:
                                ...
                                class_name = System.Convert.ToString(Util.GetClass(player.Class), System.Globalization.CultureInfo.InvariantCulture);
                    ...
                    if ((source1_ob.Type == Var_Types.INT) && (source2_ob.Type == Var_Types.STRING))
                    {
                        ...
                        switch (idType)
                        {
                            ...
                            case TargetType.NPC:
                                ...
                                break;
                            case TargetType.SELF:
                                class_name = System.Convert.ToString(Util.GetClass(Globals.gamedata.my_char.Class), System.Globalization.CultureInfo.InvariantCulture);
                            ...
                            case TargetType.PLAYER:
                                ...
                                class_name = System.Convert.ToString(Util.GetClass(player.BaseClass), System.Globalization.CultureInfo.InvariantCulture);
