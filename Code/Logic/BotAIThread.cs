    ...
    public class BotAIThread
    {
        ...
        private void BotAI()
        {
            ...
            while (Globals.gamedata.running)
            {
                ...
                if (Globals.gamedata.BOTTING && (Globals.gamedata.my_char.Cur_HP > 0))
                {
                    ...
                    {
                        //Globals.l2net_home.Add_Debug("Resting", Globals.Yellow);
                        RestBelow();
                    }
                    ...
                    if (!breaktotop && ((Globals.gamedata.botoptions.StuckCheck == 1) || (Globals.gamedata.botoptions.AutoBlacklist == 1)) && (Globals.gamedata.my_char.CurrentTargetType == TargetType.NPC) && (Globals.gamedata.my_char.isSitting == 1) && (Globals.gamedata.my_char.Cur_HP > 0) && (Globals.gamedata.my_char.TargetID != 0)) //If we have target, unstuck is activated, active target or attack is activated, char is not dead and char is not sitting down. //&& (Globals.gamedata.botoptions.Target == 1 || Globals.gamedata.botoptions.Attack == 1)
                    {
                        ...
                        if (target_hp == target_max_hp)
                        {
                            ...
                            //Globals.l2net_home.Add_Debug("Debug: Loops: " + loops + " my_x: " + my_x, Globals.Green, TextType.BOT);
                            if (loops == 1)
                            {
                                my_x = Globals.gamedata.my_char.X;
                                current_targetID = Globals.gamedata.my_char.TargetID;
                                //Globals.l2net_home.Add_Debug("Debug: Loops = 1, setting my_x to :" + my_x, Globals.Green, TextType.BOT);
                            }
                            if (current_targetID == Globals.gamedata.my_char.TargetID)
                            {
                                if ((loops == 15) && (my_x == Globals.gamedata.my_char.X)) //If the char has been stuck in the same spot for some time.
                                {
                                    ...
                                    //Globals.l2net_home.Add_Debug("Debug: Blacklist loops: " + blacklistloops, Globals.Green, TextType.BOT);
                                }
                            ...
                            {
                                //Globals.l2net_home.Add_Debug("Debug: New target", Globals.Green, TextType.BOT);
                    ...
                    if (!breaktotop && Globals.gamedata.ReadyState())
                    {
                        if (Globals.gamedata.botoptions.Target == 1)
                        {
                            if (Target())
                            {
                                //Globals.l2net_home.Add_Debug("Found target: " + new_id.ToString("X2"), Globals.Green);
                                was_smart_moving = false;
                            }
                        }
                        else
                    ...
                    if (!breaktotop && Globals.gamedata.botoptions.Target == 1 && BotOptions.Target_COMBAT == 0) //Bot it set to not KS and its set to autotarget
                    {
                        if (anti_ks_loops == Globals.gamedata.botoptions.AntiKSDelay)
                        {
                            ...
                            {
                                //Globals.l2net_home.Add_Debug("Exit locks", Globals.Green);
                        ...
                        if (Globals.gamedata.botoptions.MoveFirstNormal == 1)
                        {
                            ...
                            else
                            {
                                if (move_before_docombatloops == 25)
                                {
                                    ...
                                    //Globals.l2net_home.Add_Debug("Move to X: " + dx.ToString() + " Y: " + dy.ToString() + " Z: " + dz.ToString(), Globals.Green);
                                    //Globals.l2net_home.Add_Debug("Sending moveto packet", Globals.Cyan, TextType.BOT);
        ...
        private bool Target(uint IgnoreID)
        {
            ...
            if (need_target)
            {
                ...
                //Globals.l2net_home.Add_Debug("I'm not attacking something (need_target)", Globals.Green, TextType.BOT);
                Globals.gamedata.my_char.isAttacking = false;
        ...
        private void Attack()
        {
            ...
            else
            {
                ...
                if (!Globals.gamedata.my_char.isAttacking && (Globals.gamedata.botoptions.PetAttackSolo != 1))
                {
                    ...
                    //Globals.l2net_home.Add_Debug("Sending attack packet", Globals.Cyan, TextType.BOT);
                }
                Thread.Sleep(Globals.SLEEP_BotAIDelay);
        ...
        private void DoBuffsPart1()
        {
            try
            {
                ...
                //Globals.l2net_home.Add_Debug("I'm not attacking something (buffing)", Globals.Green, TextType.BOT);
                Globals.gamedata.my_char.isAttacking = false;
                breaktotop = true;
            }
            catch
        ...
        private void RestBelow()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        //Sit
                        //Globals.l2net_home.Add_Debug("Debug: HP or MP low, Sitting down", Globals.Green, TextType.BOT);
                    ...
                    {
                        //Stand
                        //Globals.l2net_home.Add_Debug("Debug: Finished resting, standing up", Globals.Green, TextType.BOT);
        ...
        {
            //Globals.l2net_home.Add_Debug("I'm not attacking something (stuckcheck)", Globals.Green, TextType.BOT);
            ...
            float dist;
            //Globals.l2net_home.Add_Debug("Debug: Char is stuck", Globals.Green, TextType.BOT);
            ...
            //Globals.l2net_home.Add_Debug("Debug: Current position. X: " + Globals.gamedata.my_char.X + " Y: " + Globals.gamedata.my_char.Y + " Z: " + Globals.gamedata.my_char.Z, Globals.Green, TextType.BOT);
            //Globals.l2net_home.Add_Debug("Debug: New position. X: " + newX + " Y: " + newY + " Z: " + newZ, Globals.Green, TextType.BOT);
