...
namespace L2Robot
{
    public class ItemInfo : Object_Base
    {
        ...
        public void Load(ByteBuffer buff)
        {
            ...
            //Globals.l2net_home.Add_Debug(" ID" + ID + " ItemID " + ItemID + " X " + X + " Y " + Y + " Z " + Z + " Stackable " + Stackable + " Count " + Count + " HasMesh " + HasMesh, Globals.Green, TextType.BOT);
        }
        ...
        public void LoadDrop(ByteBuffer buff)
        {
            ...
            //Globals.l2net_home.Add_Debug("length" + length + " ID" + ID + " ItemID " + ItemID + " X " + X + " Y " + Y + " Z " + Z + " Stackable " + Stackable + " Count " + Count + " HasMesh " + HasMesh, Globals.Green, TextType.BOT);
        }
        private bool CheckMobZ(uint mob)
        {
            ...
            try
            {
                ...
                //Globals.l2net_home.Add_Debug("z " + Math.Abs(Z - npc.Z), Globals.Green, TextType.BOT);
                if (npc != null)
                {
