    ...
    public class Player_Info : Object_Base
    {
        ...
        public void Load_User(ByteBuffer buff)
        {
            ...
            if (Globals.gamedata.Chron >= Chronicle.CT3_1)
            {
                ...
                //Globals.l2net_home.Add_Debug("Abn effects count: " + AbnEffCount.ToString(), Globals.Green, TextType.BOT);
        ...
        public void Clear_Botting_Buffing(bool success)
        {
            ...
            finally
            {
                ...
                this.gamedata.my_char.BuffTargetLast = Globals.gamedata.my_char.BuffTarget;
                this.gamedata.my_char.BuffTarget = 0;
                this.gamedata.BOT_STATE = BotState.FinishedBuffing;
                this.gamedata.Set_Char_To_Normal();
