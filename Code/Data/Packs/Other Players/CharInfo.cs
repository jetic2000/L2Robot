    ...
    public class CharInfo : Object_Base
    {
        ...
        public void Load(ByteBuffer buff)
        {
            ...
            for (uint i = 0; i < AbnEffCount; i++)
            {
                ...
                //Globals.l2net_home.Add_Debug("Adding abnormal vfx: " + tmpabneff.ToString("X2") + "to : " + Name, Globals.Yellow, TextType.BOT);
        ...
        public void Load_UI(ByteBuffer buff)
        {
            ...
            //Globals.l2net_home.Add_Debug("AbnormalEffects: " + AbnormalEffects.ToString("X2"), Globals.Green, TextType.BOT);
